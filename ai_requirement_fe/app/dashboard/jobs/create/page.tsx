        ...
        <div className="space-y-8">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none bg-white"
                  >
                    <option value="ENTRY_LEVEL">Mới đi làm / Junior</option>
                    <option value="MID_LEVEL">Nhân viên / Mid-level</option>
          ...
          <div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-slate-700">Lương tối thiểu (USD)</label>
                  <input
                    type="number"
                    name="salaryMin"
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-slate-700">Lương tối đa (USD)</label>
                  <input
                    type="number"
                    name="salaryMax"
