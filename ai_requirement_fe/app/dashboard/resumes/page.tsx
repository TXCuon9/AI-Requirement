...
export default function ResumesManagementPage() {
  ...
  useEffect(() => {
    ...
    if (!isAuthenticated) {
      router.push("/login?redirect=/dashboard/resumes");
      return;
    }
  ...
  return (
    <div className="flex-1 p-6 overflow-y-auto">
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Quản lý CV</h1>
          <p className="text-slate-500 text-sm mt-1">Xem, tải lên và quản lý tất cả CV của bạn.</p>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        ...
        <div className="flex-1 w-full space-y-6">
          ...
          <div className="bg-gradient-to-r from-blue-700 to-blue-600 rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between shadow-lg shadow-blue-600/10 relative overflow-hidden">
            ...
            <div className="relative z-10 text-white mb-6 sm:mb-0 max-w-lg">
              ...
              <div className="flex flex-wrap items-center gap-3 mt-6">
                <Link href="/dashboard/profile" className="bg-white text-blue-700 font-semibold px-5 py-2.5 rounded-lg hover:bg-blue-50 transition-colors flex items-center gap-2">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
              <h3 className="text-lg font-bold text-slate-900">Tất cả CV của bạn</h3>
        ...
        <div className="w-full lg:w-[320px] shrink-0 space-y-6">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm text-center relative">
            ...
            <br />
            <Link href="/dashboard/profile" className="text-blue-600 hover:text-blue-700 text-sm font-semibold transition-colors flex items-center justify-center gap-1">
